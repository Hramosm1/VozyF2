...
public class VozyAutomatizationsController : ControllerBase
{
    ...
    {
        this.cadenaDeConexionBaseDeDatos = config.GetConnectionString("conection");


        //this.cadenaDeConexionBaseDeDatos = "Server=192.168.8.6;Database=InteligenciaDB_Fase2;User ID=vozy;Password=C3vX7N5#UeXh";
        //this.cadenaDeConexionBaseDeDatos = "Server=192.168.8.3;Database=InteligenciaDB_Fase2;User ID=vozy;Password=0X6O#0d369@j";


    }
    // POST: api/VozyAutomatizations/test
    [Route("test")]
    [HttpGet]
