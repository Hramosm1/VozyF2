...
public static class Transform
{
    ...
    public static JsonData observacionesGestion(JsonData json)
    {
        ...
        if (json.contactabilidad == "True")
            json.gestion =
                $"{json.promesa_de_pago_horario} {json.fecha_pagada} {json.promesa_de_pago_2} {json.razon_de_no_pago} {json.acuerdo} {json.telefono_acuerdo_de_pago_dado}";
        else
            json.gestion =
                $"{json.promesa_de_pago} {json.promesa_de_pago_horario} {json.fecha_pagada} {json.promesa_de_pago_2} {json.razon_de_no_pago} {json.acuerdo} {json.telefono_acuerdo_de_pago_dado}";
        switch (json.resultado)
        {
            case "Promesa de Pago":
                json.gestionASubir =
                    $"{json.tel_llamada.Substring(3)} {json.detalle} el {json.fecha} {json.valor_a_pagar} {json.pago_de_intencion} {json.campaign_id}";
                break;
            case "No Contacto":
            ...
            case "Confirmar Pago":
                json.gestionASubir =
                    $"{json.tel_llamada.Substring(3)} {json.detalle} {json.situacion} {json.campaign_id}";
                break;
            default:
                json.gestionASubir =
                    $"{json.tel_llamada.Substring(3)} {json.resultado} {json.detalle} {json.situacion} {json.campaign_id}";
                break;
        }
